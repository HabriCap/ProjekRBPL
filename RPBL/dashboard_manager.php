...
<div class="welcome">
  <h4>Selamat Datang, Manager Toko 👋</h4>
  <p>
    Tinjau dan validasi laporan barang masuk
    untuk memastikan data siap diproses.
  </p>
</div>

<div class="menu">

  <div class="menu-card" onclick="location.href='review_laporan.php'">
    <div class="menu-text">📋 Review Laporan Barang Masuk</div>
    <div class="arrow">➜</div>
  </div>
