...
<div class="jenis-list" id="jenis-global-<?php echo $id_nota; ?>">

<div class="jenis-item" onclick="toggleJenis(this,'Material Bangunan')">
Material Bangunan
</div>

<div class="jenis-item" onclick="toggleJenis(this,'Besi & Logam')">
Besi & Logam
</div>

<div class="jenis-item" onclick="toggleJenis(this,'Listrik')">
Listrik
</div>

<div class="jenis-item" onclick="toggleJenis(this,'Keramik & Lantai')">
Keramik & Lantai
</div>

<div class="jenis-item" onclick="toggleJenis(this,'Alat Pertukangan')">
Alat Pertukangan
</div>

<div class="jenis-item" onclick="toggleJenis(this,'Kayu & Olahan')">
Kayu & Olahan
</div>
...
<input type="hidden" name="jenis_barang[]" class="jenis-input">

<label class="label-white">Jenis Barang</label>

<div class="jenis-list barang-jenis" data-id="<?php echo $barang['id_barang']; ?>">
...
<span 
class="jenis-item pilih-jenis"
onclick="pilihJenisBarang(this,'<?php echo $jenis; ?>',<?php echo $id_nota; ?>)">
<?php echo $jenis; ?>
</span>
...
function toggleJenis(el, jenis){

let items = document.querySelectorAll(".jenis-item");
...
document.getElementById("jenisAktifLabel").innerText = jenis;

/* isi jenis untuk barang pertama */

let first = document.querySelector(".jenis-input");
if(first){
first.value = jenis;
}
...
<input type="hidden" name="jenis_barang[]" value="${jenisAktif}">
...
function pilihJenisBarang(el, jenis, id_nota){

// reset di barang itu saja
let parent = el.parentElement;
let items = parent.querySelectorAll(".jenis-item");

items.forEach(i => i.classList.remove("active"));

el.classList.add("active");

let global = document.getElementById("jenis-global-"+id_nota);

if(global){

let globalItems = global.querySelectorAll(".jenis-item");

// reset dulu semua
globalItems.forEach(i => i.classList.remove("jenis-active"));

// nyalakan sesuai pilihan
globalItems.forEach(i => {
if(i.innerText.trim() === jenis){
i.classList.add("jenis-active");
}
});
